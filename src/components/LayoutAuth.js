...
const LayoutAuth = ({ children }) => {
  ...
  return (
    ...
    >
   {user? <div className="flex justify-end p-2 bg-white inset-x-0 top-0 absolute">
    <button
            onClick={signOut}
      ...
      <div className="mt-24 max-w-md border rounded-3xl shadow bg-white  h-full w-full text-center flex-1">
        {children}
      </div>
